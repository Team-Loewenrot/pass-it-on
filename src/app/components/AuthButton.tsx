        ...
        return (
            <div className="relative">
                <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg transition ${isDark
                ...
                {showDropdown && (
                    <>
                        ...
                        />
                        <div className={`absolute right-0 top-full mt-2 w-64 rounded-lg shadow-lg border z-20 ${isDark
                            ...
                            <div className="py-2">
                                <button
                                    ...
                                    className={`w-full px-4 py-2 text-left text-sm flex items-center gap-3 transition ${isDark
