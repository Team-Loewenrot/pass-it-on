export default function TermsPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p>
        For questions, contact us at <a href="mailto:support@challengechain.app" className="underline text-green-600 dark:text-green-400">support@challengechain.app</a>.
      </p>
    </main>
  );
}